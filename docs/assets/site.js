(function () {
  ...
  const dict = {
    en: {
      ...
      coverIssue: "Issue 0.7.0", coverEdition: "Self-hosted Edition", coverMit: "MIT / Open Source",
      ...
      footerVersion: "Issue 0.7.0 · MIT licensed", footerRights: "Your HTML files remain yours."
    },
    ...
    zh: {
      ...
      coverIssue: "刊号 0.7.0", coverEdition: "自托管版", coverMit: "MIT / 开源",
      ...
      footerVersion: "刊号 0.7.0 · MIT 许可", footerRights: "你的 HTML 文件始终属于你。"
    },
    ...
    ja: {
      ...
      coverIssue: "第 0.7.0 号", coverEdition: "セルフホスト版", coverMit: "MIT / オープンソース",
      ...
      footerVersion: "第 0.7.0 号 · MIT ライセンス", footerRights: "あなたの HTML ファイルはあなたのものです。"
    }
  };
